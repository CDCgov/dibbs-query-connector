...
13. Next, you’ll be prompted to enter secrets and API keys:
    ...
    - Next, enter your ERSD API key. [See here](development#obtaining-api-and-license-keys) for instructions for obtaining these keys – there’s no default key, because each user should use their own.
...
For more information on the ERSD and UMLS API keys, see [this API key documentation](development#obtaining-api-and-license-keys).
