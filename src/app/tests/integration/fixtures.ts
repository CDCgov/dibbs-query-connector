export const PATIENT_HL7_MESSAGE = `{
    ...
    PID|1||8692756^^^ELIS.SC.STAG&2.16.840.1.114222.4.3.4.40.1.2&ISO^PI||Unlucky^Hyper^C^^^^L||1975-12-06|M||2106-3^White^CDCREC^^^^^^White|0759 Sharp Corner^^Pamelaland^CT^^USA^H|||||U^Unknown^HL70002^^^^2.5.1||||||2135-2^Hispanic or Latino^CDCREC^^^^^^Hispanic
    }`;
