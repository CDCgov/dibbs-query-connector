...
terraform {
  backend "azurerm" {
    resource_group_name  = "dev-qc-rg"             // TODO: Change this to match the resource group that contains your storage account for Terraform state storage.
    storage_account_name = "qcdevstorageaccount"   // TODO: Change this to match the storage account that contains/will contain your Terraform state files.
